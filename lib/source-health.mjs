  ...
  const summary = {
    ...
    policy: {
      ...
      sources: Object.fromEntries(
        Object.entries(policy.sources || {}).map(([name, sourcePolicy]) => [name, {
          freshnessTargetMinutes: sourcePolicy.freshnessTargetMinutes,
          category: sourcePolicy.category,
          trustClass: sourcePolicy.trustClass,
          evidenceMode: sourcePolicy.evidenceMode,
        }])
      ),
    },
  };
