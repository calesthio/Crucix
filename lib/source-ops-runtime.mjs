...
export function loadSourceOpsWorkspace(rootDir) {
  ...
  return { profile, registry, needs, rubric, overlapRubric, pruningRubric, lifecycleTransitionPolicy, exampleScorecard, exampleOverlap, examplePruning };
}

export function buildSourceOpsSurface({ rootDir, snapshot = null } = {}) {
  const { profile, registry, needs, rubric, overlapRubric, pruningRubric, lifecycleTransitionPolicy, exampleScorecard, exampleOverlap, examplePruning } = loadSourceOpsWorkspace(rootDir);
