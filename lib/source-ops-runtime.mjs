...
export function loadSourceOpsWorkspace(rootDir) {
  ...
  return { profile, registry, needs, rubric, overlapRubric, exampleScorecard, exampleOverlap };
}

export function buildSourceOpsSurface({ rootDir, snapshot = null } = {}) {
  const { profile, registry, needs, rubric, overlapRubric, exampleScorecard, exampleOverlap } = loadSourceOpsWorkspace(rootDir);
