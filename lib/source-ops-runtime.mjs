...
export function loadSourceOpsWorkspace(rootDir) {
  ...
  return { profile, registry, needs, rubric, overlapRubric, pruningRubric, lifecycleTransitionPolicy, exampleScorecard, exampleOverlap, examplePruning, exampleLifecycleEvaluation };
}

export function buildSourceOpsSurface({ rootDir, snapshot = null } = {}) {
  const { profile, registry, needs, rubric, overlapRubric, pruningRubric, lifecycleTransitionPolicy, exampleScorecard, exampleOverlap, examplePruning, exampleLifecycleEvaluation } = loadSourceOpsWorkspace(rootDir);
