...
- Add direct per-cluster source provenance or cluster-to-runtime-source attribution so source contribution scoring stops relying on feed-type proxies like RSS→GDELT and can measure downstream quality impact more truthfully.
